<div id={{ 'slide' . $index }} class="carousel-item relative w-full flex flex-row gap-4 text-primary-content">
    ...
    <div class="flex flex-col gap-4 h-full">
        ...
        <div class="grid grid-cols-2 grid-rows-2 gap-2">
            @foreach (array_slice($images, 1, 4) as $image)
                <img src="{{ $image }}" alt="{{ $title }}" class="size-full object-cover rounded-lg" />
            @endforeach
        </div>
